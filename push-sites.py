...
SITES = [
  ...
  },
  {
    ...
    "bg":"#fffef7","bg2":"#f8f7ec","surface":"#f0efe0",
    "primary":"#166534","primary2":"#15803d","text":"#141c10","muted":"#607850","brd":"#d4d8b8",
    "font_head":"Georgia,serif","font_body":"system-ui,sans-serif","font_mono":"monospace",
...
STORIES = {
  ...
  "kanona-events": [
    ...
    "Kanona Events is the manual I assembled from twelve years of production experience. The budgeting frameworks, the vendor selection criteria, the timeline architecture that distinguishes professional events from amateur ones. Whether you are a professional planner building your process or a host running your first large event, the goal is the same.",
  ],
}
