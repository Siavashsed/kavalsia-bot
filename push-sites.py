...
SITES = [
  ...
  {
    "repo":"Siavashsed/risheh","id":"risheh","tpl":"leaf",
    "name":"Risheh","tagline":"Five decades of clinical observation",
    "category":"Clinical Dentistry Education",
    "author":"Dr. Tofigh Sedighi","author_title":"Director, Risheh Academy",
    "bio1":"مدیر آکادمی ریشە، دکتر توفیق صدیقی. زادهٔ ۱۳۴۳ در مهاباد، دانش‌آموختهٔ دندانپزشکی در سال ۱۳۶۵. پنج دهه طبابت بالینی و تدریس. زبان مادری: کردی سورانی. زبان‌های کار: فارسی، انگلیسی، عربی.",
    "bio2":"ریشە یک مؤسسهٔ آموزش پسادکتری در پنج محور است: پیشگیری و بهداشت، دندانپزشکی کودکان، ترمیمی و زیبایی، اورژانس‌های دندانی، و ارتباطات سیستمیک. هر محور دوازده درس ساخت‌یافته بر پایهٔ شواهد بالینی.",
    "hero_sub":"پنج دهه مشاهدهٔ بالینی. پنج محور آموزش پسادکتری. یک رشتهٔ علمی: حفاظت از دندان.",
    "nl_head":"نامهٔ ریشە","nl_sub":"یک نامهٔ ماهانه با یک مقالهٔ بازخوانی‌شده و یک یادداشت بالینی.",
    "footer_desc":"آکادمی ریشە، مؤسسهٔ آموزش بالینی دندانپزشکی به مدیریت دکتر توفیق صدیقی.",
